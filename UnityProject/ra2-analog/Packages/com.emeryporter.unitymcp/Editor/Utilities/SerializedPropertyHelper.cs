...
namespace UnityMCP.Editor.Utilities
{
    ...
    public static class SerializedPropertyHelper
    {
        ...
        public static Dictionary<string, object> SerializeUnityObject(UnityEngine.Object unityObject)
        {
            ...
            return new Dictionary<string, object>
            {
                { "$ref", UnityMCP.Editor.EntityIdCompat.IdOf(unityObject) },
                ...
                switch (property.propertyType)
                {
                    ...
                    case SerializedPropertyType.ObjectReference:
                        ...
                        try
                        {
                            ...
                            property.objectReferenceValue = UnityMCP.Editor.EntityIdCompat.ToObject(instanceId);
                            return true;
                        }
                        catch
                        {
        ...
        public static UnityEngine.Object ResolveObjectReference(Dictionary<string, object> refDict, Type expectedType)
        {
            ...
            {
                resolvedObject = UnityMCP.Editor.EntityIdCompat.ToObject(instanceId);
            ...
            else if (refValue is long longId)
            {
                ...
                resolvedObject = UnityMCP.Editor.EntityIdCompat.ToObject(intId);
