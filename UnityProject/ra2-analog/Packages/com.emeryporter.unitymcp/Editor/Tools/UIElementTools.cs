...
namespace UnityMCP.Editor.Tools
{
    ...
    public static class UIElementTools
    {
        ...
        private static object HandleDelete(string target)
        {
            ...
            ulong instanceId = UnityMCP.Editor.EntityIdCompat.IdOf(go);
        ...
        private static object HandleDuplicate(string target, string newParentTarget, string newName)
        {
            ...
            return new
            {
                ...
                instance_id = UnityMCP.Editor.EntityIdCompat.IdOf(duplicate),
                name = duplicate.name,
                original_instance_id = UnityMCP.Editor.EntityIdCompat.IdOf(sourceGO),
