...
namespace UnityMCP.Editor.Tools
{
    ...
    public static class ManageComponents
    {
        ...
        private static object HandleAdd(string target, string componentTypeName, object initialProperties, string searchMethod)
        {
            ...
            try
            {
                ...
                return new
                {
                    ...
                    instanceID = UnityMCP.Editor.EntityIdCompat.IdOf(targetGameObject),
                    componentType = componentTypeName,
                    componentInstanceID = UnityMCP.Editor.EntityIdCompat.IdOf(newComponent),
        ...
        private static object HandleRemove(string target, string componentTypeName, string searchMethod)
        {
            ...
            try
            {
                ulong componentInstanceId = UnityMCP.Editor.EntityIdCompat.IdOf(componentToRemove);
            ...
            string searchMethod)
        {
            ...
            return new
            {
                ...
                instanceID = UnityMCP.Editor.EntityIdCompat.IdOf(targetGameObject),
                componentType = componentTypeName,
                componentInstanceID = UnityMCP.Editor.EntityIdCompat.IdOf(component),
        ...
        private static GameObject FindGameObject(string target, string searchMethod, bool searchInactive = true)
        {
            ...
            switch (normalizedMethod)
            {
                case "by_id":
                    ...
                    {
                        var obj = UnityMCP.Editor.EntityIdCompat.ToObject(instanceId);
