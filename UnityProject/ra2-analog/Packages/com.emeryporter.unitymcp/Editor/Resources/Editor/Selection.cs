        ...
        public static object GetSelection()
        {
            ...
            return new
            {
                ...
                activeObject = activeObject != null ? new
                {
                    ...
                    instanceId = UnityMCP.Editor.EntityIdCompat.IdOf(activeObject),
                    type = activeObject.GetType().Name
                } : null,
                activeGameObject = activeGameObject != null ? new
                {
                    name = activeGameObject.name,
                    instanceId = UnityMCP.Editor.EntityIdCompat.IdOf(activeGameObject),
                ...
                selectedAssets = selectedObjects
                    ...
                    {
                        name = asset.name,
                        instanceId = UnityMCP.Editor.EntityIdCompat.IdOf(asset),
