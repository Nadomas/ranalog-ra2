...
namespace UnityMCP.Editor.Resources.Scene
{
    ...
    public static class GameObjectResource
    {
        ...
        {
            var unityObject = UnityMCP.Editor.EntityIdCompat.ToObject(instanceId);
        ...
        public static object GetGameObjectComponents([MCPParam("id", "Instance ID of the GameObject")] int instanceId)
        {
            ...
            foreach (var component in components)
            {
                ...
                componentInfoList.Add(new
                {
                    ...
                    instanceId = UnityMCP.Editor.EntityIdCompat.IdOf(component),
        ...
        private static object BuildGameObjectInfo(GameObject gameObject, bool includeComponentDetails)
        {
            ...
            var componentSummary = components
                ...
                {
                    type = c.GetType().Name,
                    instanceId = UnityMCP.Editor.EntityIdCompat.IdOf(c),
            ...
            for (int childIndex = 0; childIndex < transform.childCount; childIndex++)
            {
                ...
                {
                    name = child.name,
                    instanceId = UnityMCP.Editor.EntityIdCompat.IdOf(child.gameObject),
            ...
            return new
            {
                ...
                instanceId = UnityMCP.Editor.EntityIdCompat.IdOf(gameObject),
                tag = gameObject.tag,
                ...
                hierarchy = new
                {
                    parent = transform.parent != null ? new
                    {
                        ...
                        instanceId = UnityMCP.Editor.EntityIdCompat.IdOf(transform.parent.gameObject)
                    } : null,
            ...
            switch (property.propertyType)
            {
                ...
                case SerializedPropertyType.ObjectReference:
                    ...
                    return objRef != null ? new
                    {
                        ...
                        instanceId = UnityMCP.Editor.EntityIdCompat.IdOf(objRef)
                    } : null;
        ...
        private static Dictionary<string, object> GetReflectedProperties(Component component)
        {
            ...
            if (component is Renderer renderer)
            {
                ...
                result["materials"] = renderer.sharedMaterials
                    .Where(m => m != null)
                    .Select(m => new { name = m.name, instanceId = UnityMCP.Editor.EntityIdCompat.IdOf(m) })
                    .ToArray();
            }
            ...
            {
                result["clip"] = audioSource.clip != null ? new { name = audioSource.clip.name, instanceId = UnityMCP.Editor.EntityIdCompat.IdOf(audioSource.clip) } : null;
